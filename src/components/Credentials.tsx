...
export function Credentials() {
  return (
    <section id="credentials" className="scroll-mt-24 border-t border-line bg-panel">
      <div className="mx-auto max-w-6xl px-5 py-24 md:px-8 md:py-28">
        <Reveal>
          ...
          <h2 className="mt-4 max-w-2xl font-display text-3xl font-semibold uppercase tracking-tight text-ink md:text-4xl">
            {credentials.title}
          </h2>
        </Reveal>
        ...
        <div className="mt-14 divide-y divide-line border-y border-line">
          {credentials.items.map((item, index) => (
            <Reveal key={item.title} delay={index * 0.08}>
              <article className="grid gap-3 py-8 md:grid-cols-[160px_1fr_1.2fr] md:gap-10 md:py-10">
