  ...
  return (
    <footer className="border-t border-line bg-panel/80">
      <div className="page-pad mx-auto flex max-w-6xl flex-col gap-6 py-8 sm:py-10 md:flex-row md:items-center md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-sm text-muted sm:flex sm:flex-wrap sm:gap-5">
          <a
            href={site.emailHref}
            className="tap-target inline-flex items-center transition hover:text-signal"
          >
            Email
          </a>
          <a
